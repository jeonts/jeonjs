...
test('Round-trip Conversion Test', () => {
  test('Converts JS to JEON and back', () => {
    ...
    try {
      ...
      expect(normalizedRegenerated).toContain('class MyClass')
      expect(normalizedRegenerated).toContain('staticProperty')
      expect(normalizedRegenerated).toContain('constructor')
      expect(normalizedRegenerated).toContain('displayName')
      expect(normalizedRegenerated).toContain('addItem')
      expect(normalizedRegenerated).toContain('createInstance')

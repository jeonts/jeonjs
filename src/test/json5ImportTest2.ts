...
test('JSON5 Import Test 2', () => {
    ...
    test('Method access test', () => {
        ...
        console.log('JSON5Namespace.stringify:', typeof JSON5Namespace.stringify)
        console.log('JSON5Namespace.parse:', typeof JSON5Namespace.parse)

        expect(typeof JSON5.stringify).toBe('function')
        expect(typeof JSON5.parse).toBe('function')
        expect(typeof JSON5Namespace.stringify).toBe('function')
        expect(typeof JSON5Namespace.parse).toBe('function')
    })

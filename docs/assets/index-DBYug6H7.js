  ...
  if (typeof jeon === "object" && jeon !== null) {
    ...
    if (keys.length === 1) {
      ...
      switch (op) {
        ...
        case "++":
          if (operands !== void 0) {
            if (typeof operands === "string" && operands.startsWith("@")) {
              const varName = operands.substring(1);
              const currentValue = context2[varName] || 0;
              context2[varName] = currentValue + 1;
              return context2[varName];
            } else {
              const value = evalJeon(operands, context2);
              return value + 1;
            }
          }
          break;
        ...
        case ",":
          if (Array.isArray(operands)) {
            ...
            for (const operand of operands) {
              result2 = evalJeon(operand, context2);
              if (operand && typeof operand === "object" && !Array.isArray(operand)) {
                ...
                for (const key2 of operandKeys) {
                  if (key2.startsWith("function ") && key2.includes("(")) {
                    ...
                    if (nameMatch && result2 && typeof result2 === "function") {
                      const functionName = nameMatch[1];
                      context2[functionName] = result2;
                    }
                  }
                }
              }
        ...
        case "for":
          if (Array.isArray(operands) && operands.length === 4) {
            ...
            while (safetyCounter < maxIterations && evalJeon(operands[1], context2)) {
              result2 = evalJeon(operands[3], context2);
              evalJeon(operands[2], context2);
              safetyCounter++;
            }
            if (safetyCounter >= maxIterations) {
              console.warn("For loop exceeded maximum iterations, breaking to prevent hang");
            }
            return result2;
          }
          break;
    ...
    if (generatorFunctionDeclarationKey) {
      const nameMatch = generatorFunctionDeclarationKey.match(/function\*\s+(\w+)\(([^)]*)\)/);
      if (nameMatch) {
        nameMatch[1];
        ...
        return function(...args) {
          ...
          if (Array.isArray(body)) {
            for (const stmt of body) {
              const result2 = evalJeon(stmt, functionContext);
              if (stmt && typeof stmt === "object" && !Array.isArray(stmt) && (stmt["yield"] !== void 0 || stmt["yield*"] !== void 0)) {
                yields.push(result2);
          ...
          const iterator = {
            next: function() {
              if (currentIndex < yields.length) {
                return {
                  value: yields[currentIndex++],
                  done: false
                };
              } else {
                return {
      ...
      if (Array.isArray(arrayItems)) {
        ...
        for (const item of arrayItems) {
          if (typeof item === "object" && item !== null && !Array.isArray(item) && "..." in item) {
            ...
            } else if (spreadValue && typeof spreadValue === "object" && typeof spreadValue[Symbol.iterator] === "function") {
...
//# sourceMappingURL=index-DBYug6H7.js.map
